...
export default function BirdseyePage() {
  ...
  return (
    <div className="h-[calc(100vh-theme('spacing.32'))] flex flex-col lg:flex-row gap-6">
      {/* Left: Map Section */}
      <div className="flex-1 min-h-0 bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden relative group">
        <div className="relative w-full h-full flex items-center justify-center p-4 bg-gray-100 dark:bg-gray-900">
